...
class Peer(object):
    def __init__(self, id, number_of_pieces, ip,name, port=6881):
        #* STEVEN ADD
        self.name = name
        self.hash_info = []
        self.id = id
        ...
        self.ip = ip
        self.port = port
        self.number_of_pieces = number_of_pieces # Peer A: 100, Peer B: 010, Peer C: 001
        self.bit_field = bitstring.BitArray(number_of_pieces) # 111
        self.state = {
            'am_choking': True,
            'am_interested': False,
            'peer_choking': True,
...
# peer_swarm=[]
# peerA([hash_info="jnbbrvubfubvubfuvbufbuv"], id ="5", bitfield="10001")

# peerA(hash_info="jnbbrvubfubvubfuvbufbuv", id ="6", ....) "010011"
